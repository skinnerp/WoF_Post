...
#      cape_0to3_100mb = np.zeros((ne,ny,nx))                      #lowest 100mb mixed layer 0-3 km AGL CAPE (J/kg)
      ...
      srh_0to500 = np.zeros((ne,ny,nx))                            #0-1 km AGL storm-relative helicity (m^2/s^2)
      ...
      stp_500 = np.zeros((ne,ny,nx))                            #Significant Tornado Parameter for 100mb mixed layer
...
######### Wind values #########
   ...
   srh_0to500[f,:,:] = calc_srh(z_agl, uc, vc, dz, 0., 500., bunk_r_u[f,:,:], bunk_r_v[f,:,:])
   ...
   stp_100mb[f,:,:] = calc_stp(cape_100mb[f,:,:], lcl_100mb[f,:,:], srh_0to1[f,:,:], shear_u_0to6[f,:,:], shear_v_0to6[f,:,:], cin_100mb[f,:,:], 150.)
   stp_500[f,:,:] = calc_stp(cape_100mb[f,:,:], lcl_100mb[f,:,:], srh_0to500[f,:,:], shear_u_0to6[f,:,:], shear_v_0to6[f,:,:], cin_100mb[f,:,:], 75.)
...
srh_0to500_var = fout.createVariable('srh_0to500', 'f4', ('NE','NY','NX',))
srh_0to500_var.long_name = "0-500 m storm relative helicity"
srh_0to500_var.units = "m^2/s^2"
...
stp_500_var = fout.createVariable('stp_500', 'f4', ('NE','NY','NX',))
stp_500_var.long_name = "100-hPa mixed layer significant tornado parameter w/0-500 m SRH"
stp_500_var.units = "unitless"
...
fout.variables['srh_0to500'][:] = srh_0to500
fout.variables['srh_0to1'][:] = srh_0to1
fout.variables['srh_0to3'][:] = srh_0to3
fout.variables['stp_500'][:] = stp_500
