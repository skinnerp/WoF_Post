...
stp_500 = fin.variables["stp_500"][:,edge:-edge,edge:-edge]
...
srh_0to500 = fin.variables["srh_0to500"][:,edge:-edge,edge:-edge]
...
mean_stp_500 = np.mean(stp_500, axis=0)
...
mean_srh_0to500 = np.mean(srh_0to500, axis=0)
...
stp_plot.name = 'stp_500'
srh_plot.var1_title = 'Ens. Mean Significant Tornado Parameter w/0-500 m SRH'
env_plot(map, fig, ax1, ax2, ax3, x, y, stp_plot, mean_stp_500[:,:], pmm_dz[:,:], t, init_label, valid_label, domain, outdir, '', '', '', 5, 0, spec='False', quiv='False') 
...
srh_plot.name = 'srh0to500'
srh_plot.var1_title = 'Ens. Mean 0 - 500 m Storm Relative Helicity (m$^{2}$ s$^{-2}$)'
env_plot(map, fig, ax1, ax2, ax3, x, y, srh_plot, mean_srh_0to500[:,:], pmm_dz[:,:], t, init_label, valid_label, domain, outdir, '', '', '', 5, 0, spec='False', quiv='False')
