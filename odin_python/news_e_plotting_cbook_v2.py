...
#   wind_trop_cmap = matplotlib.colors.ListedColormap([gray1, gray2, gray3, blue1, blue2, blue3, green2, green3, green4, orange3, orange4, orange5, red4, red5, red6])
   ...
   wind_trop_cmap = matplotlib.colors.ListedColormap([gray2, gray3, blue1, blue2, blue3, blue4, blue5, orange3, orange4, orange5, orange6, orange7, red3, red4, red5, red6, red7, red8, red9, purple8, purple7])
...
############ Add text labels of plot titles and initialization and valid forecast time: ###############
   ...
   t1 = fig.text(0.03, 0.965, plot.var1_title, fontsize=10, fontweight='bold')
   t2 = fig.text(0.03, 0.945, 'Vert. Vort > 0.002 s$^{-1}$, Rain > 2 in., Wind > 64 kts', fontsize=10, fontweight='bold', color=cb_colors.gray7)
   t3 = fig.text(0.74, 0.965, init_label, fontsize=9)
   t4 = fig.text(0.74, 0.945, valid_label, fontsize=9)
...
#       label.set_visible(False)
   ...
   #ax3.axis('off')
   t7 = fig.text(0.78, 0.070, '0-2km Vort. > 0.002', fontsize=10, fontweight='bold', color=cb_colors.red9)
   t8 = fig.text(0.78, 0.048, 'Rainfall > 2 in', fontsize=10, fontweight='bold', color=cb_colors.green9)
   t9 = fig.text(0.78, 0.026, 'Wind > 64 kt', fontsize=10, fontweight='bold', color=cb_colors.blue9)
