...
wind_paint_ts_plot = v_plot('ws_80_TS_paint',                   \
                   'WoFS Member 34 Kt. Wind Gust',                        \
                   '',                  \
                   cb_colors.gray6,   \
                   cb_colors.gray6,     \
                   [900., 1000.],              \
...
wind_paint_h1_plot = v_plot('ws_80_H1_paint',                   \
                   'WoFS Member 64 Kt. Wind Gust',                        \
                   '',                  \
                   cb_colors.gray6,   \
                   cb_colors.gray6,     \
                   [900., 1000.],              \
...
wind_paint_h3_plot = v_plot('ws_80_H3_paint',                   \
                   'WoFS Member 96 Kt. Wind Gust',                        \
                   '',                  \
                   cb_colors.gray6,   \
                   cb_colors.gray6,     \
                   [900., 1000.],              \
...
radmask = wind[0,:,:] * 0. #dummy variable (will be used when MRMS obs are included) 
...
wind_ts_obj = find_objects_timestep(wind, radmask, wind_thresh_ts, area_thresh_svr)
wind_h1_obj = find_objects_timestep(wind, radmask, wind_thresh_h1, area_thresh_svr)
wind_h3_obj = find_objects_timestep(wind, radmask, wind_thresh_h3, area_thresh_svr)
...
paintqc_plot(map3, fig3, ax31, ax32, ax33, x, y, x, y, wind_paint_ts_plot, aws_qc, wind_ts_obj, radmask, t, init_label, valid_label, domain, outdir, 5, 0, blank='False')

print 'basemap part, part 4 - Citizens on Patrol ...'

map4, fig4, ax41, ax42, ax43 = create_fig(sw_lat_full, sw_lon_full, ne_lat_full, ne_lon_full, true_lat_1, true_lat_2, cen_lat, stand_lon, damage_files, resolution, area_thresh)

### Plot uh0to2 objects: 

paintqc_plot(map4, fig4, ax41, ax42, ax43, x, y, x, y, wind_paint_h1_plot, aws_qc, wind_h1_obj, radmask, t, init_label, valid_label, domain, outdir, 5, 0, blank='False')

print 'basemap part, part 5 - Pat descends into madness ...'

map5, fig5, ax51, ax52, ax53 = create_fig(sw_lat_full, sw_lon_full, ne_lat_full, ne_lon_full, true_lat_1, true_lat_2, cen_lat, stand_lon, damage_files, resolution, area_thresh)

### Plot uh0to2 objects: 

paintqc_plot(map5, fig5, ax51, ax52, ax53, x, y, x, y, wind_paint_h3_plot, aws_qc, wind_h3_obj, radmask, t, init_label, valid_label, domain, outdir, 5, 0, blank='False')
